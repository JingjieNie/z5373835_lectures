...
# `sorted_ser` is sorted so the following will return the intersection between the slice and the row labels
x = sorted_ser['b':'z']
# print(x)
# Out:
# b    2
...
# Sort the series. Note that we are not assigning this function call to a new variable.
